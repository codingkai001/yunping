...
export const classSearch = (className = '', pageNum = 1, pageSize = 50) => post('/class/search', { className, pageNum, pageSize })
...
export const classDelete = (classId) => get('/class/delete?classId=' + classId)
